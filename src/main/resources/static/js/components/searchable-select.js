...
class SearchableSelect extends HTMLElement {
    ...
    static get observedAttributes() {
        return ["disabled", "readonly", "src", "prefetch"];
    }
    ...
    _buildItems(options, filter) {
        ...
        const allOptions =
            this._isRemote && this._emptyOption
    ...
    _updateClear() {
        ...
        const show = this._selectedValue !== "" && !this.hasAttribute("disabled") && !this.hasAttribute("readonly");
