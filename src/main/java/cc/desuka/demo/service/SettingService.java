...
public class SettingService {
    ...
    /**
     * Loads all settings from DB into a typed {@link Settings} object. DB keys that match a {@link
     * Settings} field name are set automatically via {@link BeanWrapper} (handles String → boolean,
     * int, etc.). Missing keys fall back to the defaults defined in {@link Settings}.
     */
